angular.module('auction')
  .config(['$translateProvider', function ($translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      'to view the insider auction.': 'to view the insider auction.'
    });
    ...
    $translateProvider.translations('uk', {
      ...
      'Please use the': 'Будь ласка, використовуйте',
      'correct link': 'правильне посилання',
      'to view the insider auction.': 'для перегляду інсайдер аукціону.'
    });
    ...
    $translateProvider.translations('ru', {
      ...
      'correct link': 'правильную ссылку',
      'to view the insider auction.': 'для просмотра инсайдер аукциона.'
    });
  }]);
